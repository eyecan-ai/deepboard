...
# def my_ratio(img, corners):
#     h, w = img.shape[:2]
#     u0, v0 = w / 2, h / 2

#     m1 = np.append(corners[3], 1)
#     m2 = np.append(corners[2], 1)
#     m3 = np.append(corners[0], 1)
#     m4 = np.append(corners[1], 1)
#     # print(m1)
#     # print(m2)
#     # print(m3)
#     # print(m4)
...
def run(img, output_width, markers):
    ...
    ratio = board.rectified_ratio(img.shape[:2])
    print('ratio', ratio)
